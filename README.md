...
2. Download **`Notes Organiser Setup 1.0.11.exe`**
...
1. Go to **[Releases](https://github.com/PeachyTiki/NotesOrganiser/releases/latest)**
2. Download **`Notes Organiser-1.0.11-universal.dmg`**
...
# → release/Notes Organiser Setup 1.0.11.exe  (Windows)
# → release/Notes Organiser-1.0.11-universal.dmg  (Mac — requires macOS runner)
```
