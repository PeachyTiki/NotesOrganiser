...
2. Download **`Notes Organiser Setup 3.0.2.exe`**
...
1. Go to **[Releases](https://github.com/PeachyTiki/NotesOrganiser/releases/latest)**
2. Download **`Notes Organiser-3.0.2-universal.dmg`**
...
# → release/Notes Organiser Setup 3.0.2.exe  (Windows)
# → release/Notes Organiser-3.0.2-universal.dmg  (Mac — requires macOS runner)
```
