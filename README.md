...
2. Download **`Notes Organiser Setup 2.2.0.exe`**
...
1. Go to **[Releases](https://github.com/PeachyTiki/NotesOrganiser/releases/latest)**
2. Download **`Notes Organiser-2.2.0-universal.dmg`**
...
# → release/Notes Organiser Setup 2.2.0.exe  (Windows)
# → release/Notes Organiser-2.2.0-universal.dmg  (Mac — requires macOS runner)
```
