...
export default function MasterNotesModal({ customer, customerNotes, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35 backdrop-blur-md" onClick={(e) => { if (e.target === e.currentTarget) onClose() }}>
      <div className="dropdown-panel rounded-xl w-full max-w-3xl mx-4 flex flex-col" style={{ maxHeight: '85vh' }}>
        {/* Header */}
